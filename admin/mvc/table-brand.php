  ...
  <body onload="time()" class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
        ...
        />
        <div>
          <p class="app-sidebar__user-name"><b>Thành Luân</b></p>
      ...
      <ul class="app-menu">
        <li>
          <a class="app-menu__item haha active" href="index.html"
        ...
        <li>
          <a class="app-menu__item" href="table-data-product.html"
            ...
            ><span class="app-menu__label">Danh mục sản phẩm</span></a
          >
        </li>
        <li>
          <a class="app-menu__item" href="table-data-product.html"
            ><i class="app-menu__icon bx bx-purchase-tag-alt"></i
            ><span class="app-menu__label">Quản lí nhà cung cấp</span></a
          >
        </li>
        <li>
          <a class="app-menu__item" href="table-data-product.html"
              ...
              <div class="row element-button">
                <div class="col-sm-2">
                  <a
                    ...
                    title="Thêm"
                    ><i class="fas fa-plus"></i> Thêm nhà cung cấp</a
                  >
                </div>
                <div class="col-sm-2">
                  <a
