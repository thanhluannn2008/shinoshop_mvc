  ...
  <div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
        ...
        <form class="row" action="productUpdateController/update_product" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group col-md-3">
            ...
            <input class="form-control" type="text" name="product_name" value="<?php echo $row2["product_name"]?>">
          </div>
          <div class="form-group  col-md-3">
          ...
          <div class="form-group col-md-3">
            ...
            <input class="form-control" type="text" name="product_capital_price" value="<?php echo $row2["product_capital_price"]?>">
          </div>
          <div class="form-group col-md-12 custom-file-upload">
            <label for="upload">Ảnh sản phẩm<span style="color: red;" >*</span></label>
            <input name="product_img" type="file" id="upload" value="<?php echo $row2["product_img"]?>">
            <img id="preview" src="" alt="Image Preview" style="display: none;">
          </div>
          <div class="form-group col-md-12">
            <label class="control-label">Mô tả sản phẩm</label>
            <textarea class="form-control" name="mota" id="mota" value="<?php echo $row2["product_desc"]?>"></textarea>
