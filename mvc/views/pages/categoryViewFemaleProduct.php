            ...
            <div class="cartergory-right row">
                ...
                <div class="cartergory-right-content row">
                    ...
                    if ($search) {
                        ...
                        if (isset($data["outstandingProduct"])) {
                            while ($row = mysqli_fetch_array($data["outstandingProduct"])) {

                                ?>
                                <div class="cartergory-right-content-items">
                                    <a href="/mvc-project/productController/show_product/<?php echo $row["product_id"]?>">
